...
<body class="vertical-layout">
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-crm" role="tabpanel"
                                ...
                                <ul class="vertical-menu">
                                    ...
                                    <li><a href="{{route('orders.index')}}"><img
                                    ...
                                    <li><a href="#"><img
                                                ...
                                                class="img-fluid" alt="clients">المستخدمين</a></li>
                                </ul>
                            </div>
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" href="#" role="button"
                                                ...
                                                aria-expanded="false"><img
                                                    ...
                                                    class="img-fluid" alt="profile"><span class="live-icon">محمد
                                                    حمدان</span><span
                                                    class="feather icon-chevron-down live-icon"></span></a>
    ...
    <!-- Apex js -->
    <script src="{{ asset('assets/dfashboard/js/apexcharts.min.js') }}"></script>
